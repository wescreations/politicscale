...
/* WEBPACK VAR INJECTION */(function($) {document.addEventListener("turbolinks:load", function () {
  ...
  var options = {
    ...
    categories: [{
      ...
      header: "<strong></i>Candidates</strong>",
      template: {
        type: "iconLeft",
        fields: {
          iconSrc: function iconSrc(element) {
            return element['https://i.ibb.co/C64FBxQ/klobz.jpg'];
          }
        }
      }
    }, {
...
/******/ });
//# sourceMappingURL=application-319b845b95f33cbbcee9.js.map
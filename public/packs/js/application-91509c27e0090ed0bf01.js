...
/* WEBPACK VAR INJECTION */(function($) {document.addEventListener("turbolinks:load", function () {
  ...
  var options = {
    ...
    categories: [{
      ...
      header: "<strong></i>Candidates</strong>" //iconSrc: 'https://ibb.co/xjgs37j',
    ...
    template: {
      type: "iconLeft",
      fields: {
        iconSrc: "<img src='https://i.ibb.co/xjgs37j/hamster.jpg'>"
      }
    },
    list: {
...
/******/ });
//# sourceMappingURL=application-91509c27e0090ed0bf01.js.map
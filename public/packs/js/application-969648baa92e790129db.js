...
__webpack_require__(/*! packs/jquery.easy-autocomplete */ "./app/javascript/packs/jquery.easy-autocomplete.js");

__webpack_require__(/*! packs/modal */ "./app/javascript/packs/modal.js");

__webpack_require__(/*! packs/messages */ "./app/javascript/packs/messages.js");

__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'underscore'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())).start();

__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'select2'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())).start();

__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'messages'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())).start(); // Uncomment to copy all static images under ../images to the output folder and reference
...
/* WEBPACK VAR INJECTION */(function($) {function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
$(function () {
  ...
  $(document).on('click', 'a[data-modal]', function () {
    var location = $(this).attr('href'); // Load modal dialog from server
  ...
  $(document).on('ajax:success', 'form[data-modal]', function (event) {
    ...
    if (url) {
      ...
      $('.modal-backdrop').remove(); // Update modal content
...
/******/ });
//# sourceMappingURL=application-969648baa92e790129db.js.map